...
## Network Devices
![Network Devices](sources/network_devices.png)
...
Here is a simple network topology.

![Basic Network Topology](sources/basic_network_topology.png)
...
**Network Devices**: Network devices are physical devices that allow hardware on a computer network to interact and communicate with one another.
